        ...
        >
          <el-form-item label="Product Name:">
            <el-select
              ...
              @change="
                handleDesktopFilterChange('product_name', filters.product_name)
              "
            >
              <el-option
...
const updateFilterTags = () => {
  ...
  if (
    ...
    filters.product_name !== undefined &&
    filters.product_name !== ""
  ) {
...
const handleSyncInstances = async () => {
  ...
  try {
    ...
    if (res && (res as any).success) {
      ...
      ElMessage.warning(
        (res as any).message || "Sync failed, please check MQTT connection",
      );
    }
  } catch (err: any) {
