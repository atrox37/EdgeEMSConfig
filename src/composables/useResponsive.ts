...
export const BREAKPOINTS = {
  mobile: 1200, // Sidebar 折叠断点�?1280 折叠�?
  narrow: 960, // 操作列简化断点（<960 显示“更多”）
  filterCollapse: 1740, // 筛选条件折叠断�?
} as const

/**
 * 响应式布局监听 Composable
 * 
 * @returns {Object} 响应式断点状�?
 * @property {Ref<boolean>} isMobile - 窗口宽度 < 1280px（用�?Sidebar 折叠�?
